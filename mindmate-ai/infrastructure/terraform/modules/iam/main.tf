...
resource "aws_iam_role_policy" "ecs_service" {
  name = "${var.project_name}-${var.environment}-ecs-service-policy"
...
# -----------------------------------------------------------------------------
# Lambda Execution Role (for background jobs)
# -----------------------------------------------------------------------------
    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:ecs:${var.aws_region}:${var.account_id}:task-definition/${var.project_name}-${var.environment}-*:*"
      },
      {
        Effect = "Allow"
        Action = "iam:PassRole"
